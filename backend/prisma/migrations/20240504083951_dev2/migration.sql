...
-- CreateIndex
CREATE UNIQUE INDEX "Department_superviserId_key" ON "Department"("superviserId");
...
-- AddForeignKey
ALTER TABLE "Department" ADD CONSTRAINT "Department_superviserId_fkey" FOREIGN KEY ("superviserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
