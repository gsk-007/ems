...
import { useGetDepartmentsMutation } from "../../slices/departmentApiSlice";
...
const EditProfilePage = () => {
  ...
  const [getDepartments, { isLoading: departmentLoading }] =
  ...
  return (
    <NormalLayout>
      <div>
        ...
        >
          <div
            className="overflow-y-scroll overflow-x-hidden px-3 py-2"
